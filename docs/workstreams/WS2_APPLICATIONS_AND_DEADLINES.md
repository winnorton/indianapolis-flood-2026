# WS2 — Applications & Deadlines (everyone)

**Goal:** every application window is used before it closes. Applying costs nothing and
commits the user to nothing; missing a window is unrecoverable.

## Steps

1. **FEMA — apply by 2026-10-25** (DR-4933-IN) at DisasterAssistance.gov or 800-621-3362.
   Registration triggers review for the upfront $750 Serious Needs payment, displacement
...
2. **SBA — apply by 2026-10-25** (IN-20022; the SBA event record's date — a Sunday, so
   ...
   mortgage refinancing later (WS7).
   *Done when:* application accepted; decision terms requested **in writing** (script in
   the spec's Appendix C).
3. **Property-tax relief — Form 137PF by 2026-12-31** with the Marion County Assessor
   (flood-specific reassessment). Backup: Form 137R by 2027-12-31.
   *Done when:* filed with proof of delivery.
4. **State/local extras:** Indiana SDRF grant (up to ~$5,000, uninsured essential losses),
   IHCDA housing help (see WS6). Point to the state hub: in.gov/dhs → August 2026 disaster.

## Stop / escalate

- FEMA denial or award that looks wrong → 60-day appeal window; documentation alone works
  (no formal letter required). Suggest the user gather WS1 evidence and consider help from
  a Long-Term Recovery Group or legal aid before the window closes.
- Never let the user pay anyone to "file FEMA for you" — filing is free.
